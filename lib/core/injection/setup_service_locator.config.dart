...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i839.SharedPreferencesProvider>(
        () => _i839.SharedPreferencesProvider());
    gh.factory<_i527.AppBloc>(() => _i527.AppBloc());
    ...
    gh.factory<_i322.ProfileRepo>(() => _i562.ProfileRepoImp(
          gh<_i199.OtpRepoImp>(),
          gh<_i642.ProfileLocalData>(),
        ));
    gh.factoryParam<_i452.OtpCubit, _i199.OtpRepoImp, dynamic>((
      _otpRepoImp,
      _,
    ) =>
        _i452.OtpCubit(_otpRepoImp));
